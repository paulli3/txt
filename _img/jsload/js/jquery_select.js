...
.ui-selectmenu,.ui-selectmenu-menu { border:1px solid #999; width:400px;color:#666;padding-left:40px; font-style:italic; }
.ui-selectmenu.ui-selectmenu{background:url('+CONFIG.DEDIA+'/imgs/user/setting.png) no-repeat -10px -165px; }
.ui-selectmenu.ui-state-active{border:1px solid #4370ee;box-shadow: 0px 1px 10px #4370ee; color:#000}
.ui-selectmenu.ui-state-active a{ color:#000;}
.ui-selectmenu .ui-selectmenu-icon{ background:url('+CONFIG.DEDIA+'/imgs/user/setting.png) no-repeat right 0;height:100%; width:48px;position:absolute; right:0px; top: 0; background-size:73%}
.ui-selectmenu.ui-state-active .ui-selectmenu-icon{background-position-y:-38px;}
.ui-selectmenu-menu {background:#FFF; box-shadow: 0px 2px 10px #4370ee;}
.ui-selectmenu a{color:#666;}
.ui-selectmenu .ui-selectmenu-item-selected a,.country .ui-state-hover a{ color:#4370ee;}
 * */
(function(c, j) {
    function k(a) {
...
function jquery_select_init(id,param)
{
	param['height'] = 1;
