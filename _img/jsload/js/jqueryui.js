 ...
 * @param q 内容
 * @param w 标题
 * @param s 按钮  {"确定":function(){},"取消":""}
 * @param f 倒计时关闭
 * @param o 宽度
 * @param m 高度
 * @returns
 */
function jqueryui_showmsg(q,w,s,f,o,m){
	
	var v=f;
	messageBoxIndex = 1;
	messageBoxIndex++;
	o=typeof(o)==undefined ? 350:o;
	m=typeof(m)==undefined ? 220:m;
	content_height=m-72;
	var n='messageBox'+messageBoxIndex;
	var div = $('<div id="'+n+'" style="display:none;" title=""></div>');
	div.appendTo("body");
	w=w==undefined? "友情提示 :": w;
	div.attr("title",w);
	var j=$('<table width="100%" height="'+content_height+'" border="0" cellspacing="0" cellpadding="0"><tr><td align="center" valign="middle" style="padding-top:10px;"></td></tr></table>');
	j.find("td").append(q);
	div.append(j);
	var k=function(){
		//location = "#abc";
	...
	if(s==undefined){
		s={"确定":function(){$(this).dialog("close")}}
	}
	var r=div.dialog({width:o,modal:true,draggable:true,buttons:s,resizable:false,position:c,open:k,close:function(y,x){div.dialog("destroy").remove(); $().enableSelection()}});
	return r;
}
 ...
 * @param param
 */
function jqueryui_dialog(div,title,param)
{
	...
	var setting = {
			width:'auto',
			title : title  != undefined ? title : '提示信息',
			modal:true,
			draggable:true,
			resizable:true ,
			dialogClass:'dialog',
			...
			//position:c,
			//open:k,
			//close:function(){$(this).dialog("close"); $().enableSelection()}
	};
	for (var i in param)
	{
		setting[i] = param[i];
...
function jqueryui_dialogChangeContent(div,html)
{
	if (typeof div != 'object')
	{
		div = jQuery("#"+div);
